...
- **Transmitters** broadcast the radio beneath them across the dimension by default (Can be changed to universal inlcuding modded dimensions in the config). They **only** broadcast while their chunk is loaded.
