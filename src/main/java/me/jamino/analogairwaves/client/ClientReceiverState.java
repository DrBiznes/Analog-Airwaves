...
import me.jamino.analogairwaves.server.StationResolution;
...
public final class ClientReceiverState {
    ...
    /**
     * Mirrors {@link me.jamino.analogairwaves.server.ReceiverService#getHeldReceiver}: the main
    ...
    private static void announceTransition(ReceiverSignalS2C signal) {
        ...
        Component message = switch (signal.resolution()) {
            case NO_SIGNAL -> Component.translatable("message.analogairwaves.no_signal", signal.frequency());
            case INTERFERENCE -> Component.translatable("message.analogairwaves.interference", signal.frequency());
            case PLAYING -> Component.translatable("message.analogairwaves.playing",
                    signal.frequency(),
